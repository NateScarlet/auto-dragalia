...
import * as giveUpButtonBluePng from '@/assets/images/give-up-button-blue.png';
import * as giveUpButtonWhitePng from '@/assets/images/give-up-button-white.png';
import * as levelSelectBeginnerPng from '@/assets/images/level-select-beginner.png';
import * as levelSelectExpertPng from '@/assets/images/level-select-expert.png';
import * as levelSelectMasterPng from '@/assets/images/level-select-master.png';
...
import * as noRareItem2Png from '@/assets/images/no-rare-item-2.png';
import * as noRareItem3Png from '@/assets/images/no-rare-item-3.png';
import * as noRareItem4Png from '@/assets/images/no-rare-item-4.png';
import * as okButtonPng from '@/assets/images/ok-button.png';
import * as presentButtonPng from '@/assets/images/present-button.png';
import * as presentPrice0Png from '@/assets/images/present-price-0.png';
import * as presentPrice1500Png from '@/assets/images/present-price-1500.png';
import * as presentPrice15000Png from '@/assets/images/present-price-15000.png';
import * as presentPrice4000Png from '@/assets/images/present-price-4000.png';
import * as presentPrice8000Png from '@/assets/images/present-price-8000.png';
import * as rareItem1Png from '@/assets/images/rare-item-1.png';
import * as rareItem2Png from '@/assets/images/rare-item-2.png';
import * as repeatBattleButtonPng from '@/assets/images/repeat-battle-button.png';
import * as repeatWithStaminaButtonPng from '@/assets/images/repeat-with-stamina-button.png';
import * as retryButtonBluePng from '@/assets/images/retry-button-blue.png';
import * as retryButtonRedPng from '@/assets/images/retry-button-red.png';
import * as startBattleButtonPng from '@/assets/images/start-battle-button.png';
import * as supportSelectButtonPng from '@/assets/images/support-select-button.png';
import * as supportSkillAvailablePng from '@/assets/images/support-skill-available.png';
...
export const noRareItem2: Image = images.fromBase64(noRareItem2Png);
export const noRareItem3: Image = images.fromBase64(noRareItem3Png);
export const noRareItem4: Image = images.fromBase64(noRareItem4Png);
