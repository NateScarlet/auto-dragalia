...
import continueButtonBluePng from '@/assets/images/continue-button-blue.png';
...
import noRareItemPng from '@/assets/images/no-rare-item.png';
...
export const noRareItem: Image = images.fromBase64(noRareItemPng);
